--RELOAD GUI
if game.CoreGui:FindFirstChild("sysbroken") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Poteto hub",Text = "GUI Already loaded, rejoin to re-execute",Duration = 5;})
	return
end
local version = 2
--VARIABLES
